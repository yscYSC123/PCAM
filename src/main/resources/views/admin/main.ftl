    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll layui-left-menu">
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                        ...
                        <li class="layui-nav-item">
                            <a href="javascript:;" class="layui-menu-tips" data-tab="doctor/index" data-tab-mpi="m-p-i-1" target="_self"><i class="fa fa-user-circle-o"></i><span class="layui-left-nav"> 咨询师管理</span></a>
                        </li>
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-1" data-tab="customer_serve/index/1" target="_self"><i class="fa fa-envelope-open"></i><span class="layui-left-nav"> 收件箱</span></a>
                                    </dd>
                                    <dd>
