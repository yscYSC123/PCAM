            ...
            <form class="layui-form">
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input type="text" name="content" class="layui-input searchVal" placeholder="试题" />
                    </div>
        ...
        layui.use(['table','layer'],function(){
            ...
            var tableIns = table.render({
                ...
                ,cols: [[
                    ...
                    ,{field: 'content', title: '试题内容',align:'center'}
                    ,{field: 'answer', title: '参考答案',align:'center'}
                    ,{field: 'topicTime', title: '创建时间',align:'center'}
            ...
            function openAddOrUpdateUserDialog(id) {
                var title = "<h3>添加试题</h3>";
                var url = ctx + "/topic/toPage";
                //判断id是否为空
                if (id != null && id != ''){
                    title = "<h3>修改试题</h3>";
                    url += '?id=' + id;
